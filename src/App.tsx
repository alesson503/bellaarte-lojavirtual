      ...
      <header className="site">
        <div className="shell nav">
          <button className="brand" onClick={() => goPage('inicio')}>
            <span className="mark"><StarIcon /></span>
          ...
          <div className="nav-right">
            ...
            <a className="cta-whats" href="#" onClick={e => e.preventDefault()}>
      ...
      {page === 'inicio' && (
        <div className="shell hero">
          <div className="hero-grid">
            <div>
              <div className="eyebrow"><span className="dot" />Feito à mão, sob encomenda</div>
              <h1 className="serif">Sua marca, <em>impressa</em><br />do jeito certo.</h1>
              <p className="lede">Adesivos, cartões de visita, canecas e muito mais — 60 produtos já cadastrados, prontos pra você escolher o formato, a quantidade e ver o preço na hora.</p>
            ...
            <div className="peel-stage">
              <div className="stage-card">
                ...
                <div><b>Bella Arte</b><br /><span>Cartão de Visita</span></div>
              </div>
              <div className="sticker-hero">
                <div className="ring" />
                <div className="stamp">
                  <div className="word1">Bella Arte</div>
                  <div className="word2 serif">Adesivos</div>
                  <div className="word3">à prova d'água</div>
                </div>
              </div>
